...
public class UserJpaResource {
    ...
    public UserJpaResource(UserRepository theRepository, PostRepository postRepository){
        this.userRepository = theRepository;
    ...
    public List<Post> retrivePostsById(@PathVariable int id){
        Optional<User> user = userRepository.findById(id);
